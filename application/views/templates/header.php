...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
        <div class="container">
        <a class ="navbar-brand" href="<?= base_url('landing_home'); ?>">SIP<span class="text-lowercase">etani</span></a>
        <button class="navbar-toggler js-fh5co-nav-toggle fh5co-nav-toggle" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav"
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav nav ml-auto">
                <li class="nav-item">
                    <a href="<?= base_url('landing_home/'); ?>" class="nav-link color"><span>Home</span></a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('landing_home/#layanan'); ?>" class="nav-link color"><span>Layanan</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <?php if ($this->uri->segment(1) == 'login'): ?>
                        <a href="<?= base_url('login'); ?>" class="nav-link active"><span>Login</span></a>
                    <?php else: ?>
